    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          <Card
            ...
            right={<span className="text-xs text-gray-500">Score {cvScore}</span>}
          >
            {cvExperiences.length === 0 ? (
              <div className="text-sm text-gray-600">
                No hay CV estructurado todavía. Sube tu CV para generar experiencias verificables.
              </div>
            ) : (
              <div className="space-y-3">
                {cvExperiences.slice(0, 6).map((exp: any, idx: number) => (
                  <div key={idx} className="border border-gray-200 rounded-2xl p-4">
                    ...
                    <div className="text-xs text-gray-500">
                      ...
                      {exp.matched_verification_id ? " · Verified" : ""}
                    </div>
                    {exp.description ? (
