...
const flags = [
  { key: "owner_growth_sync", label: "Provider Sync Growth", value: "Activo" },
  { key: "owner_issue_desk", label: "Issue Desk", value: "Activo" },
  { key: "owner_marketing_promos", label: "Marketing Promos", value: "Activo" },
  { key: "owner_company_profile", label: "Company Profile Module", value: "Activo" },
];
    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-slate-900">Feature Flags (v1)</h2>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <ul className="mt-4 space-y-2 text-sm text-slate-700">
          ...
          <li className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2">Mantener monitoreo de errores y retries desde Issue Desk y AI-Ops.</li>
        </ul>
      </section>
    </div>
  );
